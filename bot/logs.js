...
var MOD_CHANNEL = config.logchannel;

client.on("channelDelete", function(channel) {
    const embed = new EmbedBuilder()
    .setAuthor(channel.guild.name + ": Channel Deleted", channel.guild.iconURL())
    .setDescription(`**#${channel.name}** Just got deleted and it was the **${channel.type}** channel.`)
    .setColor("Red");
...
client.on("channelCreate", function(channel) {
    ...
    .setDescription(`Someone just created **#${channel.name}** and it is the **${channel.type}** channel.`)
    .setColor("Green");
    return client.channels.cache.get(MOD_CHANNEL).send({embeds: [embed1]});
});
  client.on("channelUpdate", function(oldChannel, newChannel) {
    ...
    .setAuthor(
      ...
      .setColor("Blue");
    return client.channels.cache.get(MOD_CHANNEL).send({embeds: [embed2]});
  });
  ...
  client.on("emojiCreate", function(emoji) {
    ...
    let embed3 = new EmbedBuilder()
      ...
      .setColor("Green");
    return client.channels.cache.get(MOD_CHANNEL).send({embeds: [embed3]});
  });
  ...
  client.on("emojiDelete", function(emoji) {
    ...
    let embed4 = new EmbedBuilder()
      ...
      .setColor("RED");
    return client.channels.cache.get(MOD_CHANNEL).send({embeds: [embed4]});
  });
